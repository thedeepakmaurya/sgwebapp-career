    ...
    <footer className="xl:px-[8%] px-[4%] bg-[#100f1f] text-white max-w-[100vw]">
      <div className="flex xl:flex-row lg:flex-row md:flex-row flex-col justify-center gap-10 xl:gap-12 xl:py-20 py-16">
        <div className="flex flex-col gap-4 ">
          ...
          />
          <p className="text-lg ">
            At SG web app Techniques, we believe that IT should be an enabler,
            not a hindrance.
          </p>
        ...
        <div>
          <ul className="flex flex-col gap-3">
            ...
            <li className="text-nowrap hover:text-[#fe4c1c]">
              <Link href="https://www.sgwebapp.com/case-studies">
                Case Studies
              </Link>
            </li>
            <li className="hover:text-[#fe4c1c]">
        ...
        <div>
          <ul className="flex flex-col gap-3">
            ...
            <li className="hover:text-[#fe4c1c]">
              <Link href="https://www.sgwebapp.com/team">Meet Team</Link>
            </li>
            <li className="hover:text-[#fe4c1c]">
              <Link href="https://www.sgwebapp.com/testimonials">
                Testimonials
              </Link>
            </li>
            <li className="hover:text-[#fe4c1c]">
              <Link href="https://www.sgwebapp.com/contact">Contact</Link>
            </li>
          </ul>
        </div>
        <div>
      ...
      <div className="flex xl:flex-row lg:flex-row flex-col xl:justify-between lg:justify-between justify-center py-6 text-lg">
        <p className="xl:w-1/2 w-full text-center xl:text-left lg:text-left pb-2">
          ...
          <Link className="text-[#fe4c1c]" href="/">SG Web App Techniques Pvt. Ltd.
          </Link></span>
        </p>
        <p className="xl:w-1/2 w-full xl:text-right lg:text-right text-center">
          <Link href="https://www.sgwebapp.com/terms-of-service">
            Terms & Conditions
          </Link><span> | </span>
          
          <Link href="https://www.sgwebapp.com/privacy-policy">
            Privacy Policy
          </Link>
        </p>
      </div>
